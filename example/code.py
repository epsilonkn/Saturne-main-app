...
button = customtkinter.CTkButton(action_frame, border_spacing = 2, text = 'Valider')
...
checkbox = customtkinter.CTkCheckBox(sub_frame, checkbox_width = 24, checkbox_height = 24, text = '', onvalue = 1, offvalue = 0)
